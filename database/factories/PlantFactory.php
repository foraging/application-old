...
$factory->define(Plant::class, function (Faker $faker) {
    ...
    return [
        ...
        'type' => collect(['berry', 'grain', 'herb', 'mushroom', 'nut', 'root', 'seed', 'vegetable'])->random(),
        'description' => $faker->sentence(300),
        'image' => $images[array_rand($images)],
        'edible' => $faker->boolean,
        'poisonous' => $faker->boolean,
        'spring' => $faker->boolean,
        'summer' => $faker->boolean,
        'autumn' => $faker->boolean,
        'winter' => $faker->boolean,
    ];
});
